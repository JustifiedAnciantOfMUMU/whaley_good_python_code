...
class audio_time_series_generator (keras.utils.Sequence):
    ...
    def __getitem__(self, index):
        ...
        for _ in range(self.batch_size):
            ...
            if max_val != min_val:
                normalized_array = (audio - min_val) / (max_val - min_val)
            else:
                normalized_array = audio

            batch_X.append(normalized_array)
...
time_step = 0.1
learning_rate = 0.01
model_name = '071023_BiLSTM_Upsweep Normalised'
epochs = 50
...
train_ds = audio_time_series_generator(r'E:/Thesis/Datasets/230831_upsweep_wav/train', sample_rate=sample_rate)
validation_ds = audio_time_series_generator(r'E:/Thesis/Datasets/230831_upsweep_wav/val', sample_rate=sample_rate)
